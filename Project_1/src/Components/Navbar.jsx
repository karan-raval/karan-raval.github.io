  ...
  const handleKeyDown = (e) => {
    if (e.key === "Enter") {
      if (
        ...
        inputValue == "hair" ||
        inputValue == "Hair" ||
        inputValue == "HAIR SERUM" ||
        inputValue == "hair serum" ||
        inputValue == "Hair Serum" ||
        inputValue == "HAIRSERUM" ||
        inputValue == "hairserum" ||
        inputValue == "Hairserum" ||
        inputValue == "Hair serumm"
      ) {
        ...
        inputValue == "lipstick" ||
        inputValue == "foundation" ||
        inputValue == "nailpolish" ||
        inputValue == "Lipstick" ||
        inputValue == "Foundation" ||
        inputValue == "Nailpolish" ||
        inputValue == "nail polish" ||
        inputValue == "Nail polish" ||
        inputValue == "Nail Polish" ||
        inputValue == "LIPSTICK" ||
        inputValue == "FOUNDATION" ||
        ...
        inputValue == "facewash" ||
        inputValue == "mosturizer" ||
        inputValue == "serum" ||
        inputValue == "Facewash" ||
        inputValue == "Mosturizer" ||
        inputValue == "Serum" ||
        inputValue == "Face wash" ||
        inputValue == "Face Wash" ||
        inputValue == "FACEWASH" ||
        inputValue == "MOSTURIZER" ||
        inputValue == "SERUM" ||
        ...
        inputValue == "Cream" ||
        inputValue == "facecare" ||
        inputValue == "face care" ||
        inputValue == "face products" ||
        inputValue == "Face products" ||
        inputValue == "Face Products" ||
        inputValue == "FACE PRODUCTS" ||
        inputValue == "FACEPRODUCTS" ||
        inputValue == "faceserum" ||
        inputValue == "face serum" ||
        inputValue == "Faceserum" ||
        inputValue == "FACESERUM" ||
        inputValue == "FACE SERUM" ||
        inputValue == "Face Serum" ||
      ...
      <div className="upperNav">
        ...
        <div className="uprnavbtn">
          <a href="https://www.nykaa.com/installApp">
            <i class="bx bx-mobile-alt"></i> Get App{" "}
          </a>
          <a>|</a>
          <a href="https://www.nykaa.com/stores-n-events-desktop">
            <i class="bx bx-current-location"></i> Store & Events{" "}
          </a>
          <a>|</a>
          <a href="https://www.nykaa.com/giftcard/list">
            <i class="bx bx-gift"></i> Gift Card{" "}
          </a>
          <a>|</a>
          <a href="https://www.nykaa.com/help-center?dl_type=help_center">
      ...
      <nav>
        <div className="wrapper">
          <ul className="navlinks">
            ...
            <li className="hover-button" onMouseEnter={handleHover}>
              <a onClick={() => navigate("/allproducts")} href="#">
                Categories
              </a>
            </li>
                ...
                <div className="content">
                  <div className="row">
                    ...
                    <ul class="mega-links">
                      <li>
                        <img
                          src="https://adn-static2.nykaa.com/media/wysiwyg/2019/Maybelline1211.png"
                          alt=""
                        />
                      </li>
                      <li>
                        <img
                          src="https://adn-static2.nykaa.com/media/wysiwyg/lakme_mega_menu_header.png"
                          alt=""
                        />
                      </li>
                      <li>
                        <img
                          src="https://adn-static2.nykaa.com/media/wysiwyg/2019/lorealparis.png"
                          alt=""
                        />
                      </li>
                      <li>
                        <img
                          src="https://adn-static2.nykaa.com/media/wysiwyg/cms/beauty/menu/mac.png"
                          alt=""
                        />
                      </li>
                      <li>
                        <img
                          src="https://adn-static2.nykaa.com/media/wysiwyg/2018/Biotique_new.png"
                          alt=""
                        />
                      </li>
                    </ul>
                  ...
                  <div className="mega-box3">
                    <div className="content">
                      <div>
                        <button
                          className="logout"
                          onClick={() => dispatch(setUserLogin(false))}
                        >
            ...
            <div className="addtocart">
              ...
              <div style={{ visibility: `${display}` }} className="mega-box4">
                <div className="upper">
                  ...
                  <p className="quantity">{totalQuantity} items</p>
                </div>
